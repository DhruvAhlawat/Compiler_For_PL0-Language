...
fun yyAction39 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (T.IDENT(yytext,!lin,!col))
      end
       ...
       of NONE => yyAction38(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #")"
              ...
              then yyQ35(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
            else if inp < #"0"
              then yyAction38(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ35(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
       ...
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              ...
              then yyQ33(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
              else yyAction37(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"a"
                  then yyQ51(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
                  else yyAction39(strm, yyNO_MATCH)
            else if inp <= #"z"
              then yyQ39(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
              else yyAction39(strm, yyNO_MATCH)
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ53(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
            else if inp < #"r"
              then if inp <= #"`"
                  then yyAction39(strm, yyNO_MATCH)
                  else yyQ39(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"i"
                  then yyQ72(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
                  else yyQ39(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ39(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
              else yyAction39(strm, yyNO_MATCH)
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ78(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
            else if inp < #"e"
              then if inp <= #"`"
                  then yyAction39(strm, yyNO_MATCH)
                  else yyQ39(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ84(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
            else if inp < #"n"
              then if inp <= #"`"
                  then yyAction39(strm, yyNO_MATCH)
                  else yyQ39(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"a"
                  then yyQ83(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
                  else yyAction39(strm, yyNO_MATCH)
            else if inp <= #"z"
              then yyQ39(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
              else yyAction39(strm, yyNO_MATCH)
...
fun yyQ19 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ85(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))

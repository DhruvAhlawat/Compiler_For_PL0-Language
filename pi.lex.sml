       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #")"
              ...
              then if inp = #"("
                  then yyQ35(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
...
fun yyQ65 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ40(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ40(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
                else if inp < #"0"
       ...
       of NONE => yyAction41(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              ...
              else yyQ98(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
      (* end case *))

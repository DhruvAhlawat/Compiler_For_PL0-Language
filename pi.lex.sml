...
fun yyAction34 (strm, lastMatch : yymatch) = (yystrm := strm;
      (col := !col + 5;T.FALSE(!lin,!col)))
fun yyAction35 (strm, lastMatch : yymatch) = (yystrm := strm;
      (col := !col + 4;T.TRUE(!lin,!col)))
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              ...
              then if inp = #"."
                  then yyQ37(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction45(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"e"
...
fun yyQ92 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ44(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ44(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ20 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction21(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ102(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #","
              ...
              then if inp = #")"
                  ...
                  else yyQ107(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp = #"/"
...
fun yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction5(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ114(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
